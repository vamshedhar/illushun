...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "d61d82747eeb189c89e0f38a215c101a")
			{
				if($queryarray['lvl'] == 23)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=24 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level24.php'\",0);</script>";
...
<div id="ans">
<form action="level23.php" method="post">
