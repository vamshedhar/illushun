...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "4c474e99b137ff1ae743a1051f3f9da2")
			{
				if($queryarray['lvl'] == 18)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=19 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level19.php'\",0);</script>";
...
<div id="ques">
<img src="0/try1.jpg" /> <img src="0/try2.jpg" /> 
</div>
<div id="ans">
<form action="level18.php" method="post">
...
<!--Hint :
		I'm hungry. Fava beans and chianti sound really good right now.
-->
