...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "04baa3677376e459a123a676a18d1e28")
			{
				if($queryarray['lvl'] == 8)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=9 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level9.php'\",0);</script>";
...
<div id="ques">
<img src="0/l81.jpg"height="200" width="140" />
<img src="0/lv82.jpg" height="200" width="140" />
<img src="0/lvl83.jpg"height="200" width="140" />
<img src="0/lvl84.jpg"height="200" width="140" />
</div>
<div id="ans">
