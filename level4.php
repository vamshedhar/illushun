...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "1f1f58f0bd276b83310728d159a5100e")
			{
				if($queryarray['lvl'] == 4)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=5 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level5.php'\",0);</script>";
...
<div id="ques">
<img src="0/hgv.jpg" height="300" width="300" />
<img src="0/lgj.jpg" height="300" width="200" />
</div>
<div id="ans">
