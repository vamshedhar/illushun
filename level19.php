...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "b237b012930cbcfb3dba8e367c9fcff4")
			{
				if($queryarray['lvl'] == 19)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=20 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level20.php'\",0);</script>";
...
<div id="ques">
For the first time I opened my eyes<br /> 
saw a streak of light in the High Skies<br />
my works made people to admire<br />
as i entertained them with pure satire<br />
for the last time the eyelids were about to descend<br />
and the same light was there again, to bid adieu, under the crescent 
</div>
<div id="ans">
