...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		...
		{
			$ans = ans($_POST['ans']);
			if($ans == "75e994daffb582b7ae32f5cb6042463f")
			{
				if($queryarray['lvl'] == 3)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=4 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level4.php'\",0);</script>";
...
<div id="ques">
<img src="0/kls.jpg" height="200" width="150" />
<img src="0/hfo.gif"height="200" width="150" />
<img src="0/kfh.jpg" height="200" width="150" />
</div>
<div id="ans">
