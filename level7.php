...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "28b82f05758614597f458f22e59881dc")
			{
				if($queryarray['lvl'] == 7)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=8 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level8.php'\",0);</script>";
...
<div id="ques">
<p><h1>WHERE AM I???</h1>
I lie below that line <br />
which gets the maximum sunshine,<br />
river is what its name means<br />
in the language spoken in this city of greens<br />
and in distant future we'll ignite the lamp<br />
that too for the first time in our camp.
</p>
</div>
<div id="ans">
