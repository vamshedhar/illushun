...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		...
		{
			$ans = ans($_POST['ans']);
			if($ans == "aec6963ff57817de5abf9d82efe16ad8")
			{
				if($queryarray['lvl'] == 1)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=2 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level2.php'\",0);</script>";
			}
...
<div id="main">
<div id="ques" align="center">
<img src="0/asd.png" height="180" width="600" />
*Check source for hint
</div>
<div id="ans">
