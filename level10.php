...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "7fdd500e86cab874d046212e1f3fa1c1")
			{
				if($queryarray['lvl'] == 10)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=11 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level11.php'\",0);</script>";
...
<div id="ques">
<img src="0/chi.jpg" height="280" width="200" />
<img src="0/ntan.gif" height="280" width="200" />
</div>
<div id="ans">
<form action="level10.php" method="post">
