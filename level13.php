...
if(isset($_SESSION['email']))
{
	...
	if($queryarray['uid'] == $uid)
	{
		if(isset($_POST['ans']))
		{
			...
			if($ans == "1e6f1d090f302cec97a8e017da62de1f")
			{
				if($queryarray['lvl'] == 13)
				{
				date_default_timezone_set('Asia/Kolkata');
				$clear = date("d/m/Y H:i:s");
				$update = mysql_query("UPDATE illushun SET lclear='$clear', lvl=14 WHERE email='$email'");
				}
			echo "<script type='text/javascript'>setTimeout(\"window.location = 'level14.php'\",0);</script>";
...
<div id="ques">
<img src="0/pen.png" width="600" height="100" />
</div>
<div id="ans">
